...
.footer {text-align:center;margin:20px 0;color:#ccc;}
}
.goPay{ position: fixed;bottom: 10px;left: 5%;display: inline-block;width: 90%;height: 100px; background-color: white;box-shadow: 0 10px 10px #ccc; }
</style>