...
.shopCard{
    ...
    .title{ position: fixed; top: 0;left: 0;z-index: 10;width: 100%;height: 120px;line-height: 120px;text-align: center; font-size: 30px;font-weight: bold;background-color: coral;color: #fff;}
